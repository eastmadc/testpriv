...
#else
int	compat_30_sys_socket(struct lwp *, void *, struct file **);
#endif
...
#else
int	sys_kqueue(struct lwp *, void *, struct file **);
#endif
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/lib/io-pkt/sys/sys/syscallargs.h $ $Rev: 812397 $")
#endif
