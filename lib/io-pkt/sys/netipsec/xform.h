...
#ifdef __QNXNTO__
	/* Don't use struct ifnet since it might go away--use name */
	char		tc_ifname[ IFNAMSIZ ];
#endif
};
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/lib/io-pkt/sys/netipsec/xform.h $ $Rev: 680336 $")
#endif
