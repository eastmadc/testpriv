...
/* National SemiConductor DP83620 */
void DumpVendor_DP83620(mdi_t *mdi, int PhyAddr);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/lib/io-pkt/sys/lib/libnetdrvr/public/netdrvr/mdi.h $ $Rev: 836518 $")
#endif
