...
#ifdef __QNXNTO__
static int  AESXCBCMAC_setkey(void *, const uint8_t *, int len);
static int  AESXCBCMAC_Update(void *, const uint8_t *, uint16_t);
static void AESXCBCMAC_Final(uint8_t *, void *);
#endif
...
static const struct swcr_auth_hash swcr_auth_hash_null = {
	&auth_hash_null,
	null_init, null_update, null_final, NULL
};

static const struct swcr_auth_hash swcr_auth_hash_hmac_md5_96 = {
	&auth_hash_hmac_md5_96,
	(void (*) (void *)) MD5Init, MD5Update_int,
	(void (*) (u_int8_t *, void *)) MD5Final, NULL
};

static const struct swcr_auth_hash swcr_auth_hash_hmac_sha1_96 = {
	&auth_hash_hmac_sha1_96,
	SHA1Init_int, SHA1Update_int, SHA1Final_int, NULL
};

static const struct swcr_auth_hash swcr_auth_hash_hmac_ripemd_160_96 = {
	&auth_hash_hmac_ripemd_160_96,
	(void (*)(void *)) RMD160Init, RMD160Update_int,
	(void (*)(u_int8_t *, void *)) RMD160Final, NULL
};
...
static const struct swcr_auth_hash swcr_auth_hash_sha1 = {
	&auth_hash_sha1,
	(void (*)(void *)) SHA1Init, SHA1Update_int,
	(void (*)(u_int8_t *, void *)) SHA1Final, NULL
};

static const struct swcr_auth_hash swcr_auth_hash_hmac_sha2_256 = {
	&auth_hash_hmac_sha2_256,
	(void (*)(void *)) SHA256_Init, SHA256Update_int,
	(void (*)(u_int8_t *, void *)) SHA256_Final, NULL
};

static const struct swcr_auth_hash swcr_auth_hash_hmac_sha2_384 = {
	&auth_hash_hmac_sha2_384,
	(void (*)(void *)) SHA384_Init, SHA384Update_int,
	(void (*)(u_int8_t *, void *)) SHA384_Final, NULL
};

static const struct swcr_auth_hash swcr_auth_hash_hmac_sha2_512 = {
	&auth_hash_hmac_sha2_384,
	(void (*)(void *)) SHA512_Init, SHA512Update_int,
	(void (*)(u_int8_t *, void *)) SHA512_Final, NULL
};

static const struct swcr_auth_hash swcr_auth_hash_cipher_aes_xcbc_mac = {
	&auth_hash_aes_xcbc_mac, NULL,
	AESXCBCMAC_Update, AESXCBCMAC_Final, AESXCBCMAC_setkey 
};
...
#ifdef __QNXNTO__
static int 
AESXCBCMAC_setkey(void *ctx, const uint8_t *key, int len)
{

	return (ah_aes_xcbc_mac_init(ctx, key, len));
}

static int 
AESXCBCMAC_Update(void *ctx, const uint8_t *buf, uint16_t len)
{
	
	ah_aes_xcbc_mac_loop(ctx, buf, len);
	return 0;
}

static void
AESXCBCMAC_Final(uint8_t *blk, void *ctx)
{
	ah_aes_xcbc_mac_result(blk, ctx);
}
#endif
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/lib/io-pkt/sys/opencrypto/cryptosoft_xform.c $ $Rev: 680336 $")
#endif
