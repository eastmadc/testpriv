...
#define PKT_CACHE_MAX 64
#endif

#ifndef MTAG_CACHE_MAX
#define MTAG_CACHE_MAX 128
#endif

/* Per thread caches */
extern int mbuf_cache_max;
extern int pkt_cache_max;
extern int mtag_cache_max;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/lib/io-pkt/sys/nw_thread.h $ $Rev: 858532 $")
#endif
