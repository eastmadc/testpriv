/*	$NetBSD: resolv_mt.h,v 1.1.1.2.2.3 2007/05/17 21:25:12 jdc Exp $	*/
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/lib/socket/include/resolv_mt.h $ $Rev: 680336 $")
#endif
