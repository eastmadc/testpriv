...
/*	$NetBSD: ev_timers.c,v 1.2.10.2 2007/05/17 21:25:14 jdc Exp $	*/
...
#else
#ifndef __QNXNTO__
__RCSID("$NetBSD: ev_timers.c,v 1.2.10.2 2007/05/17 21:25:14 jdc Exp $");
#endif
#endif
#endif
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/lib/socket/isc/ev_timers.c $ $Rev: 680336 $")
#endif
